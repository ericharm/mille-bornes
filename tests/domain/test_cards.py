...
def test_safety_card_does_not_cure_condition() -> None:
    safety_card = cards.ExtraTank()
    assert cards_domain.safety_card_cures_condition(safety_card, Condition.accident) is False
...
def test_find_safety_card_in_hand() -> None:
    ...
    hand = [extra_tank, out_of_gas, gasoline]
...
def test_find_end_of_limit_card_in_hand() -> None:
    ...
    hand = [speed_limit, right_of_way, end_of_limit]
...
def test_find_remedy_card_in_hand() -> None:
    ...
    hand = [spare_tire, puncture_proof, flat_tire]
...
def test_find_remedy_card_not_in_hand() -> None:
    ...
    puncture_proof = cards.PunctureProof()
    flat_tire = cards.FlatTire()
    hand = [go, puncture_proof, flat_tire]
...
def test_find_longest_distance_card_in_hand() -> None:
    ...
    hand = [distance_25, distance_50, distance_75]
...
def test_find_longest_distance_card_in_hand_with_speed_limit_not_playable() -> None:
    ...
    hand = [distance_75, distance_100, distance_200]
...
def test_card_target_is_self(card, target_is_self) -> None:
